...
public class HmbbsCleaner extends Configured implements Tool{
	...
	static class LogParser {
		...
		public static void main(String[] args) throws ParseException {
			...
			System.out.println("鏍蜂緥鏁版嵁锛�"+S1);
			System.out.format("瑙ｆ瀽缁撴灉锛� ip=%s, time=%s, url=%s, status=%s, traffic=%s", array[0], array[1], array[2], array[3], array[4]);
		}
		/**
		 * 瑙ｆ瀽鑻辨枃鏃堕棿瀛楃涓�
		 * @param string
		 ...
		 * 瑙ｆ瀽鏃ュ織鐨勮璁板綍
		 * @param line
		 * @return 鏁扮粍鍚湁5涓厓绱狅紝鍒嗗埆鏄痠p銆佹椂闂淬�url銆佺姸鎬併�娴侀噺
		 */
